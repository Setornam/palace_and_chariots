...
class _EventDetailsPageState extends State<EventDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
        stream: bloc.retrieve(widget.eventService.id),
        builder: (BuildContext context, AsyncSnapshot<EventService> snapshot) {
          if (snapshot.hasData) {
            return Scaffold(
              appBar: AppBar(
                    ...
                    child: GestureDetector(
                      onTap: () async {
                        ...
                        DocumentReference docRef = FirebaseFirestore.instance
                            .doc('event-services/${widget.eventService.id}');

                        if (snapshot.data!.isFavorite == false) {
                          await Wishlist.addToWishlist(
                              widget.eventService.id,
                              widget.eventService.name,
                              FirebaseAuth.instance.currentUser!.uid,
                              'event-rentals',
                              widget.eventService.price,
                              widget.eventService.images.first,
                              '',
                              '',
                              '',
