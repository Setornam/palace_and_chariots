                                                        ...
                                                        child: GestureDetector(
                                                          onTap: () {
                                                            Navigator.push(
                                                                ...
                                                                MaterialPageRoute(
                                                                    builder: (BuildContext context) => VehicleDetailsPage(
                                                                        color: lexusList[index]
                                                                            .color,
                                                                        name: lexusList[index]
                                                                            .name,
                                                                        luggage:
                                                                            lexusList[index]
                                                                                .luggage,
                                                                        numberOfSeats:
                                                                            lexusList[index]
                                                                                .seats,
                                                                        price: lexusList[index]
                                                                            .price,
                                                                        rating: lexusList[index]
                                                                            .rating,
                                                                        images: [],
                                                                        otherFeatures: [],
                                                                        transmission:
                                                    ...
                                                    child: GestureDetector(
                                                      onTap: () {
                                                        Navigator.push(
                                                            ...
                                                            MaterialPageRoute(
                                                                builder: (BuildContext context) => VehicleDetailsPage(
                                                                    color: BMWBusList[index]
                                                                        .color,
                                                                    name: BMWBusList[index]
                                                                        .name,
                                                                    luggage:
                                                                        BMWBusList[index]
                                                                            .luggage,
                                                        ...
                                                        child: GestureDetector(
                                                          onTap: () {
                                                            Navigator.push(
                                                                ...
                                                                MaterialPageRoute(
                                                                    builder: (BuildContext context) => VehicleDetailsPage(
                                                                        color: lexusBusList[index]
                                                                            .color,
                                                                        name: lexusBusList[index]
                                                                            .name,
                                                                        luggage:
                                                                            lexusBusList[index]
                                                                                .luggage,
                                                                        numberOfSeats:
                                                                            lexusBusList[index]
                                                                                .seats,
                                                                        price: lexusBusList[index]
                                                                            .price,
                                                                        rating: lexusBusList[index]
                                                                            .rating,
                                                                        images: [],
                                                                        otherFeatures: [],
                                                                        transmission:
