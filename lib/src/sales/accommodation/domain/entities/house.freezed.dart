...
mixin _$House {
  ...
  ///property size
  String get propertySize => throw _privateConstructorUsedError;
  ...
  ///amenities
  Map<String, String> get amenities => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      furnishing: null == furnishing
          ...
          : furnishing // ignore: cast_nullable_to_non_nullable
              as String,
      propertySize: null == propertySize
          ? _value.propertySize
...
//facilities
  ...
  ///amenities
  @override
  Map<String, String> get amenities {
...
abstract class _House implements House {
  factory _House(
      ...
      required final List<String> facilities,
      required final Map<String, String> amenities,
      required final String condition}) = _$_House;
